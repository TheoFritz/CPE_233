...
set rc [catch {
  ...
  catch { report_drc -file WRAPPER_drc_routed.rpt -pb WRAPPER_drc_routed.pb -rpx WRAPPER_drc_routed.rpx }
  catch { report_methodology -file WRAPPER_methodology_drc_routed.rpt -rpx WRAPPER_methodology_drc_routed.rpx }
  catch { report_power -file WRAPPER_power_routed.rpt -pb WRAPPER_power_summary_routed.pb -rpx WRAPPER_power_routed.rpx }
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx WRAPPER.ltx}
