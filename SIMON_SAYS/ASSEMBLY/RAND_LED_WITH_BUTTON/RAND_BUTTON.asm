...
CHECK_BTN_STATUS: IN R23, BTN_STATUS ; TAKES IN THE VALUE FROM BUTTON_STATUS
IN R23, BTN_STATUS
CMP R23, 0x00
BREQ CHECK_BTN_STATUS ; IF NOT IT WILL LOOP BACK AROUND AND CONTINUE TO CHECK
SUB R23, 0x01
