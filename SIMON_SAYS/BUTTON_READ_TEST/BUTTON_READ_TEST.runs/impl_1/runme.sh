...
HD_PWD='C:/Users/dgaiero/Documents/School/College/Year_2/Quarter_2/CPE_233/SIMON_SAYS/BUTTON_READ_TEST/BUTTON_READ_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log READ_BUTTON.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source READ_BUTTON.tcl -notrace
