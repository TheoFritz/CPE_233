...
HD_PWD='C:/Users/dgaiero/Documents/School/College/Year_2/Quarter_2/CPE_233/SIMON_SAYS/BUTTON_READ_TEST/BUTTON_READ_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log READ_BUTTON.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source READ_BUTTON.tcl
