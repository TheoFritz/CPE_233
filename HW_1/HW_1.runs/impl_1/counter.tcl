...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/utilities/CPE_233/HW_1/HW_1.cache/wt [current_project]
  set_property parent.project_path C:/utilities/CPE_233/HW_1/HW_1.xpr [current_project]
  set_property ip_output_repo C:/utilities/CPE_233/HW_1/HW_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/utilities/CPE_233/HW_1/HW_1.runs/synth_1/counter.dcp
  read_xdc C:/utilities/CPE_233/HW_1/HW_1.srcs/constrs_1/imports/BASYS_FILES/Basys3_constraints.xdc
