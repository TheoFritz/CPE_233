...
HD_PWD='C:/Users/dgaiero/Documents/School/College/Year_2/Quarter_2/CPE_233/HW_2/VIVADO/HW_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPEAKER_DRIVER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPEAKER_DRIVER.tcl
