...
HD_PWD='C:/Users/dgaiero/Documents/School/College/Year_2/Quarter_2/CPE_233/HW_2/VIVADO/HW_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPEAKER_DRIVER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPEAKER_DRIVER.tcl -notrace
