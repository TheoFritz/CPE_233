...
HD_PWD='C:/utilities/CPE_233/RAT_2/VIVADO/RAT_2/RAT_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log program_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source program_counter.tcl -notrace
